...
class CreatorTests(AuthenticatedAPITestCase):
    ...
    def test_get_creators(self) -> None:
        ...
        self.assertEqual(response.data["results"][0]["name"], "Test Creator")
        self.assertEqual(response.data["results"][0]["uri"], "http://example.com/creator")

    def test_get_creator_detail(self) -> None:
    ...
    def test_post_creator(self) -> None:
    ...
    def test_put_creator(self) -> None:
    ...
    def test_readonly_creator_fields(self) -> None:
    ...
    def test_delete_creator(self) -> None:
    ...
    def test_anonymous_user_cannot_post_creator(self) -> None:
...
class ContextTests(AuthenticatedAPITestCase):
    ...
    def setUpTestData(cls) -> None:
        ...
        cls.context_detail = reverse("context-detail", kwargs={"pk": cls.context_id})
        cls.context_list = reverse("context-list")
    ...
    def test_get_contexts(self) -> None:
        ...
        self.assertEqual(response.data["count"], 1)
        self.assertEqual(len(response.data["results"]), 1)
        self.assertEqual(response.data["results"][0]["name"], "Test Context")
        self.assertEqual(response.data["results"][0]["uri"], "http://test.com/context")

    def test_get_context_by_id(self) -> None:
    ...
    def test_context_readonly_fields(self) -> None:
    ...
    def test_anonymous_user_cannot_post_context(self) -> None:
...
class PITests(AuthenticatedAPITestCase):
    ...
    def setUpTestData(cls) -> None:
        ...
        cls.pi.save()
        cls.pi_id = cls.pi.id
        cls.pi_detail = reverse("pi-detail", kwargs={"pk": cls.pi_id})
        cls.pi_list = reverse("pi-list")

    def test_get_pis(self) -> None:
        ...
        self.assertEqual(response.data["count"], 1)
        self.assertEqual(len(response.data["results"]), 1)
        self.assertEqual(response.data["results"][0]["name"], "Test PI")
        self.assertEqual(response.data["results"][0]["uri"], "http://test.com/pi")

    def test_get_pi_by_id(self) -> None:
    ...
    def test_pi_readonly_fields(self) -> None:
    ...
    def test_anonymous_user_cannot_post_pi(self) -> None:
...
class EventTests(AuthenticatedAPITestCase):
    ...
    def setUpTestData(cls) -> None:
        ...
        cls.event_detail = reverse("event-detail", kwargs={"pk": cls.event_id})
        cls.event_list = reverse("event-list")
    ...
    def test_get_events(self) -> None:
        ...
        self.assertEqual(response.data["results"][0]["uri"], "http://test.com/event")
    ...
    def test_event_readonly_fields(self) -> None:
        ...
        self.assertEqual(response.data["id"], str(self.event_id))
        self.assertEqual(data["name"], self.event.name)
    ...
    def test_anonymous_user_cannot_post_event(self) -> None:
...
class LicenseTests(AuthenticatedAPITestCase):
    ...
    def setUpTestData(cls) -> None:
        ...
        cls.license_detail = reverse("license-detail", kwargs={"pk": cls.license_id})
        cls.license_list = reverse("license-list")
    ...
    def test_get_licenses(self) -> None:
        ...
        self.assertEqual(response.data["count"], 1)
        self.assertEqual(len(response.data["results"]), 1)
        self.assertEqual(response.data["results"][0]["name"], "Test License")
        self.assertEqual(response.data["results"][0]["uri"], "http://test.com/license")
    ...
    def test_license_readonly_fields(self) -> None:
    ...
    def test_post_license(self) -> None:
    ...
    def test_anonymous_user_cannot_post_license(self) -> None:
...
class PlatformTests(AuthenticatedAPITestCase):
    ...
    def test_get_platforms(self) -> None:
        ...
        self.assertEqual(response.data["results"][0]["uri"], "http://test.com/platform")
    ...
    def test_platform_readonly_fields(self) -> None:
    ...
    def test_post_platform(self) -> None:
    ...
    def test_anonymous_user_cannot_post_platform(self) -> None:
...
class ProjectTests(AuthenticatedAPITestCase):
    ...
    def test_get_projects(self) -> None:
        ...
        self.assertEqual(response.data["results"][0]["uri"], "http://test.com/project")
    ...
    def test_project_readonly_fields(self) -> None:
    ...
    def test_anonymous_user_cannot_post_project(self) -> None:
...
class SensorTests(AuthenticatedAPITestCase):
    ...
    def test_get_sensors(self) -> None:
        ...
        self.assertEqual(response.data["count"], 1)
        self.assertEqual(len(response.data["results"]), 1)
        self.assertEqual(response.data["results"][0]["name"], "Test Sensor")
        self.assertEqual(response.data["results"][0]["uri"], "http://test.com/sensor")

    def test_get_sensor_by_id(self) -> None:
    ...
    def test_sensor_readonly_fields(self) -> None:
    ...
    def test_post_sensor(self) -> None:
    ...
    def test_anonymous_user_cannot_post_sensor(self) -> None:
...
class RelatedMaterialTests(AuthenticatedAPITestCase):
    ...
    def test_get_related_materials(self) -> None:
        ...
        self.assertEqual(response.data["count"], 1)
        self.assertEqual(len(response.data["results"]), 1)
        self.assertEqual(response.data["results"][0]["title"], "Test RelatedMaterial")
        self.assertEqual(response.data["results"][0]["uri"], "http://test.com/relatedmaterial")
        self.assertEqual(response.data["results"][0]["relation"], "Test Relation")

    def test_get_related_material_by_id(self) -> None:
    ...
    def test_update_related_material(self) -> None:
    ...
    def test_related_material_readonly_fields(self) -> None:
    ...
    def test_post_related_material(self) -> None:
    ...
    def test_delete_related_material(self) -> None:
    ...
    def test_anonymous_user_cannot_post_related_material(self) -> None:

...
router_fields.register("image_camera_calibration_model", ImageCameraCalibrationModelViewSet)
router_fields.register("image_camera_housing_viewport", ImageCameraHousingViewportViewSet)
router_fields.register("image_camera_pose", ImageCameraPoseViewSet)
router_fields.register("image_domeport_parameter", ImageDomeportParameterViewSet)
router_fields.register("image_flatport_parameter", ImageFlatportParameterViewSet)
router_fields.register("image_photometric_calibration", ImagePhotometricCalibrationViewSet)

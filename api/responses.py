"""Shared collection and RFC 9457 error responses."""
...
def collection_response(results: list, *, meta: dict | None = None) -> Response:
    """Return a complete collection using the same envelope as a page."""

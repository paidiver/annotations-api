...
To deploy the application using Helm, follow the instructions in the [paidiver-annotations-api-helm repo](https://gitlab.com/nocacuk/BODC/server-config/kubernetes/paidiver-annotations-api-helm). You may need to have permissions to access the repository.

## Docker images

Docker images are published to:

`ghcr.io/paidiver/annotations-api`

...
4. Fill in the required passwords:
   ...
   5. **CACHED_WORMS_API_TOKEN**: A token used to authenticate requests to the WORMS Cache API. Found in OnePassword under `DSG_BODC_GENERIC`. Search for "PAIDIVER DEV WORMS API Cache Token".
...
3. **Django Secret Key**
    ...
    -e "s/{{CACHED_WORMS_API_TOKEN}}/$CACHED_WORMS_API_TOKEN/g" \
...
---
### 5. Create Postgres PersistentVolumeClaim
...
---
### 6. Cluster Issuer for TLS certificates
...
---
### 8. Set chart version in Helmfile
...
```
---
### 9. Set Docker image version in Helmfile
